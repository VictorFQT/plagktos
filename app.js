...
secondVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.second_v} width="700" type="video/mp4" preload="auto" ></video>
    <p class="copyright-video">Gutrug N°1 - Werner Nekes <i>1894</i></p>
`
thirdVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.third_v} width="700" type="video/mp4" preload="auto" ></video>
